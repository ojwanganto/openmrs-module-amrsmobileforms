        ...
        $j("#resolveError").dialog({
            ...
            buttons: {
                "Resolve Error": function () {
                    ...
                    var providerId =  document.getElementById('selprovider').value==null;
                    ...
                    var url ="resolveErrorsFromDialog.htm";
                    var params = [];
                    params.push("householdId="+householdId);
                    params.push("errorId="+errorId);
                    params.push("errorItemAction="+errorItemAction);
                    params.push("birthDate="+birthDate);
                    params.push("patientIdentifier="+patientIdentifier);
                    params.push("providerId="+providerId);
                    params.push("householdIdentifier="+householdIdentifier);
                    ...
                    if (errorItemAction != null) {
                       ...
                       /*DWRAMRSMobileFormsService.resolveError(householdId, errorId, errorItemAction, birthDate,
                        patientIdentifier, providerId, householdIdentifier,patientId, resolveErrorResult);*/
                    } else {
